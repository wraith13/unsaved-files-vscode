...
export module UnsavedFiles
{
    ...
    function getConfiguration<type>(key? : string, section : string = "unsaved-files") : type
    {
    ...
    export function registerCommand(context : vscode.ExtensionContext): void
    {
        ...
        (
            ...
            (
                'unsaved-files-vscode.showSystemInformation', showSystemInformation
            )
        );
    }
    ...
    {
        const thisExtension = vscode.extensions.getExtension("wraith13.unsaved-files-vscode");
        return pass_through =
        {
    ...
    export async function showSystemInformation() : Promise<void>
    {
        ...
        (
            [
                {
                    "label": "Basic Unsaved Files",
                    "description": "",
                    "detail": "basic, extensions"
                },
                {
                    "label": "Full Unsaved Files",
    ...
    export function informationToMarkdown(information : any) : string
    {
        return pass_through =
        [
            makeMarkdownHeader(1, "VS Code Unsaved Files"),
